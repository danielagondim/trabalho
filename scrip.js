        ...
        <!-- Carrega os Estados --> 
            $('#btnEstados').click(function(e){
                ...
                $.getJSON('consulta.php?opcao=estado', 
                          ...
                          { Reset(); $('#mensagem').html('<span class="mensagem">Não foram encontrados estados!</span>');
                          }}) 
             <!-- Carrega as Cidades --> $('#cmbEstado').change(function(e){ 
             ...
             <!-- Resetar Selects --> function Reset(){ 
                 $('#cmbEstados').empty().append('<option>Carregar Países</option>>'); 
